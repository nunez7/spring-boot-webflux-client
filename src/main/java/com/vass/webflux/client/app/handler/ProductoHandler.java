package com.vass.webflux.client.app.handler;
...
import com.vass.webflux.client.app.models.services.ProductoService;
...
public class ProductoHandler {
	...
	public Mono<ServerResponse> verPorId(ServerRequest request) {
		...
		return errorHandler(
				...
				p -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(Mono.just(p), Producto.class))
	...
	public Mono<ServerResponse> crear(ServerRequest request) {
		...
		return producto.flatMap(p -> {
			...
			return service.save(p);
				...
				.contentType(MediaType.APPLICATION_JSON).body(Mono.just(p), Producto.class)).onErrorResume(error -> {
	...
	public Mono<ServerResponse> upload(ServerRequest request) {
		String id = request.pathVariable("id");
		return errorHandler(
				request.multipartData().map(multipart -> multipart.toSingleValueMap().get("file")).cast(FilePart.class)
